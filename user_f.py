...
def search_user1_text():
    user_b.search_user1(aadharnumber_text.get(), name_text.get())
    list1.delete(0, END)
    for rows_search in user_backend.search_user1(aadharnumber_text.get(),name_text.get()):
        list1.insert(END, rows_search)

def view_user1_text():
    list1.delete(0, END)
    for rows_view in user_b.view_user1():
        list1.insert(END,rows_view)

def insert_user1_text():
    user_b.insert_user1(aadharnumber_text.get(),name_text.get(),age_text.get(),gender_text.get(),nationality_text.get(),source_text.get(),destination_text.get(),foodservice_text.get(),berthpreference_text.get(),coach_text.get(),departuretime_text.get(),arrivaltime_text.get())
    list1.delete(0, END)
    list1.insert(END,aadharnumber_text.get(),name_text.get(),age_text.get(),gender_text.get(),nationality_text.get(),source_text.get(),destination_text.get(),foodservice_text.get(),berthpreference_text.get(),coach_text.get(),departuretime_text.get(),arrivaltime_text.get())
